...
public class ProjectExample {
	...
	public static void main(String[] args) {
		...
		try {
			...
			for(int i = 0; i<25; i++){
				Cloudlet cloudlet1 = new Cloudlet(i, (int)(length * (Math.random()+0.5)), pesNumber, fileSize, outputSize, utilizationModel, utilizationModel, utilizationModel);
				cloudlet1.setUserId(brokerId1);
				cloudletList1.add(cloudlet1);
			}
			for(int i = 0; i<25; i++){
				Cloudlet cloudlet2 = new Cloudlet(id, (int)(length * (Math.random()+0.5)), pesNumber, fileSize, outputSize, utilizationModel, utilizationModel, utilizationModel);
